% LOGISCHE GRAMMATICA's. Lab Week 2

% Met dit fragment kan je de Grail installatie uitproberen.
% Een aantal van de gevraagde typeringen zijn al voorbij gekomen
% in de type-inferentie code van lg17_p2.pl!
