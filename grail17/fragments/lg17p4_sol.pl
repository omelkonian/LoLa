...
4 :: a/a :: Q^F^(Q@(X^Y^((F@(I^('$a$'@(X@I))))@(J^('$c$'@(Y@J)))))).
5 :: a/a :: Q^F^(Q@(X^Y^((F@(I^(X@('$b$'@I))))@(J^(Y@('$d$'@J)))))).
6 :: a :: F^((F@(J^J))@(J^J)).

"3 4 4 5 5 5 6" ===> s. % aabbbccddd
"3 4 5 4 5 5 6" ===> s. % elke permutatie van 44555 geeft het gewenste rijtje
