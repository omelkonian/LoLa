% Natuurlijke taalverwerking 2013. Week 4
...
himself :: obj :: R^X^(R@X@X). % obj afkorting voor tv\iv
...
%niet :: obj/obj :: Term?. % voor: Tweedledum weet niet alles
%of :: (s\s)/s :: P^Q^(Q \/ P). % voor: Iedereen danst of iedereen zingt
%of :: (iv\iv)/iv :: Term?. % voor: Iedereen danst of zingt
%en :: (tv\tv)/tv :: Term?. % voor:  Alice jent en sart Tweedledum
%en :: Type? :: Term?. % voor: Alice zocht en vond iemand
